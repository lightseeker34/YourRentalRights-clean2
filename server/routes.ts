...
import { insertLogSchema, updateProfileSchema, User, insertForumCategorySchema, insertForumPostSchema, insertForumReplySchema } from "@shared/schema";
import "./types";
...
import { uploadDir, uploadEvidence, uploadForumAttachment } from "./uploads";
